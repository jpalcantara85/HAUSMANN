...
Why should you use **GLquery?** Because instead of individually running N separate queries on Google's environment, you can use **GLquery** to run all that with a one-line command - all you need to do is change the function parameters.

...
print("Type 'help(GLquery)' to learn more about GLquery.")
...
# Em vez de rodar funcao, deixar ela automatica (tipo um pacote)
# criar funcao para analisar quantidade de palavras
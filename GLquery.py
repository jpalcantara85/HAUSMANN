...
1) Type 'help(GLquery)' to learn more about GLquery.

      

2) Type 'GLquery_examples()' to see examples.
...
GLquery takes the following arguments:
    ...
    - examples (True or False): list of examples of queries with different parameters (default is False)
...
3. OBSERVATIONS:
    ...
    - If you haven't already, you must create a variable named 'my_key_path' to access Google's environment (.json file): e.g. my_key_path = "/Users/jpalcantara/Patents/My Project 1-1e3a04e30599.json"
    ...
    - You might need to install the following package before running this script: pip install -e git+https://github.com/SohierDane/BigQuery_Helper#egg=bq_helper
